...
export function SignatureTour() {
  return (
    <section id="tours" className="relative min-h-[500px] sm:h-[600px] flex items-center justify-center py-12 sm:py-0">
      ...
      <div className="relative z-10 text-[var(--cream)] px-5 sm:px-6 max-w-3xl">
        <motion.div
        ...
        >
          ...
          <h2 className="text-white mb-4 sm:mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight" style={{ fontFamily: 'var(--font-playfair)' }}>
            Promos & Packages
          </h2>
          <p className="text-white/90 mb-8 sm:mb-10 leading-relaxed text-base sm:text-lg md:text-xl font-light" style={{ fontFamily: 'var(--font-inter)' }}>
